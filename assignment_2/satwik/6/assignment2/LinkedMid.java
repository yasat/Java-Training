...
public class LinkedMid {
	public static void main(String[] args) {
		...
		System.out.println("for second mid: "+lkl.get((lkl.size()/2)));
		...
		if(lkl.size()%2==0) {
			System.out.println("for first mid: "+lkl.get((lkl.size()/2)-1));
		}
		else {
			System.out.println("for first mid: "+lkl.get((lkl.size()/2)));
		}
	}
}
